...
**If Chrome asks for a "single purpose" statement:**
```
...
- ⚡ Quick changes: jump 0.5x with one click
- 🖱️ Mouse wheel support for instant adjustments
- 💾 Remembers your preference
- 🌐 Works on every video platform

**Perfect for:**
- Students cramming for exams
- Professionals slogging through compliance training
- Lifelong learners consuming online courses
